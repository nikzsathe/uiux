...
export const skillcard_Languages: SkillItemType[] = [
  {
    ...
    icon: <CustomIcon path='/icons/adobe.png' size={46} />,
    skillLevel: '100%',
  },
  {
    text: 'Sketch',
    icon: <CustomIcon path='/icons/sketch-brand.256x230.png' size={46} />,
    skillLevel: '100%',
  },
  {
    text: 'Figma',
    icon: <CustomIcon path='/icons/figma.176x256.png' size={46} />,
    skillLevel: '100%',
  },
  {
    text: 'InVision',
    icon: <CustomIcon path='/icons/invision.256x256.png' size={46} />,
    skillLevel: '100%',
  },
];
export const skillcard_Frameworks: SkillItemType[] = [
  {
    text: 'Axure RP',
    icon: <CustomIcon path='/icons/rpcs3.256x239.png' size={39} />,
    skillLevel: '100%',
  },
  {
    text: 'Zeplin',
    icon: <CustomIcon path='/icons/zeplin-thin.256x211.png' size={39} />,
    skillLevel: '100%',
  },
  {
    text: 'Marvel',
    icon: <CustomIcon path='/icons/marvel.256x177.png' size={40} />,
    skillLevel: '100%',
  },
  {
    text: 'UserTesting',
    icon: <CustomIcon path='/icons/usertesting.256x66.png' size={45} />,
    skillLevel: '100%',
  },
];
